...
Gem::Specification.new do |s|
  ...
  s.date = %q{2009-11-22}
  s.description = %q{scala-dbc packaged up in a JavaGem}
  ...
  s.summary = %q{A JavaGem version of scala-dbc - packaged by JavaGems (http://www.javagems.org) - original by LAMP/EPFL (http://lamp.epfl.ch/)}
